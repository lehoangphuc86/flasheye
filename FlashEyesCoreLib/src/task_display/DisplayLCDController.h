...
#ifndef _DISPLAY_LCD_CONTROLLER_H
#define _DISPLAY_LCD_CONTROLLER_H

/////////////////////////////////////////////////
// INCLUDE
#include "../libs/lcd/LiquidCrystal/LiquidCrystal.h"
...
class DisplayLCDController
  : public DisplayController
{
public:
  DisplayLCDController(void);
  virtual ~DisplayLCDController(void);
...
protected:
  ...
  LiquidCrystal*                                                lcd_Controller; // for lcd device only
};

#endif // _DISPLAY_LCD_CONTROLLER_H
