...
#ifndef _DISPLAY_SC_CONTROLLER_H
#define _DISPLAY_SC_CONTROLLER_H
...
class DisplaySCController
  : public DisplayController
{
public:
  DisplaySCController(void);
  virtual ~DisplaySCController(void);
...
protected:
  int                                                           createSocket(DisplaySCDeviceConfigTAG& socketConfig);
  int                                                           setSocketConfig(DisplaySCDeviceConfigTAG& socketConfig);
protected:
  HardwareSerial*                                               lcd_Controller;
};

#endif // _DISPLAY_SC_CONTROLLER_H
